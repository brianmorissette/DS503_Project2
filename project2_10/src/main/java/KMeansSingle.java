...
public class KMeansSingle {
    ...
    public static void main(String[] args) throws Exception {
        if (args.length != 3) {
            System.err.println("Usage: KMeansSingle <k> <input path> <output path>");
            System.exit(-1);
        }
        ...
        // Generate k random seeds within data bounds
        ...
        try {
            ...
            Job job = Job.getInstance(conf, "4D K-Means Single Iteration");
